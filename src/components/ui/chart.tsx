...
import "./../../styles/others/chart.css";
                ...
                <>
                      ...
                      <div
                        className={cn(
                          "chart-tooltip-indicator",
                          {
                            ...
                            "chart-tooltip-indicator-nested": nestLabel && indicator === "dashed",
                          },
                        )}
                        style={
                          {
                  ...
                  <div
                    className={cn(
                      ...
                      nestLabel ? "chart-tooltip-item-content-nested" : "chart-tooltip-item-content-normal",
                    )}
                  >
                    {nestLabel ? tooltipLabel : null}
                    <span className="chart-tooltip-item-name">
