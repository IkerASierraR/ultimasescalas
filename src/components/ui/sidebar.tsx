    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          side={side}
        >
          <SheetHeader className="sidebar-sr-only">
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "sidebar-container",
          side === "left" && "sidebar-container-left",
          side === "right" && "sidebar-container-right",
  ...
  "sidebar-menu-button",
  {
    variants: {
      ...
      size: {
        ...
        sm: "sidebar-menu-button-sm-size",
        lg: "sidebar-menu-button-lg-size",
      },
    },
    defaultVariants: {
      variant: "default",
